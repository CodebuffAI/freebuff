...
**Choice of leading models** — The regular CLI picker includes GLM 5.3 Flash, DeepSeek, GPT-6 Luna, MiMo 2.6 Flash, MiMo 2.6 Pro, Solar Mini 4, Space Bunny Alpha, Gemini 3.8 Flash, and Muse Spark 1.2, with GLM 5.3 Flash selected by default.
...
**What is limited mode?** Limited mode lets you use Freebuff outside the full-access countries, or while using a VPN. It includes GLM 5.3 Flash, DeepSeek V4.1 Flash, MiMo 2.6 Flash, and Solar Mini 4, with 6 one-hour sessions per day, and you can earn up to 7 by engaging with promoted posts on the Earn page.
